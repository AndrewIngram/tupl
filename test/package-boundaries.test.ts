...
const STRUCTURAL_LINE_BUDGETS = {
  ...
  "packages/planner/src/planner/simple-select-lowering.ts": 1200,
  ...
  "packages/planner/src/planner/sql-expr-utils.ts": 800,
  "packages/planner/src/planner/aggregate-lowering.ts": 1200,
  "packages/planner/src/planner/aggregate-ordering.ts": 800,
  ...
  "packages/runtime/src/runtime/execution-plan-builder.ts": 800,
  "packages/runtime/src/runtime/session.ts": 100,
  "packages/runtime/src/runtime/provider-fragment-session.ts": 800,
  ...
  "packages/schema-model/src/builder-helpers.ts": 800,
  "packages/schema-model/src/mapping.ts": 250,
  "packages/schema-model/src/rel-output-inference.ts": 800,
} as const;
